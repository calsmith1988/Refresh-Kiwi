      ...
      <section className="relative z-10 px-5 pb-20 pt-14 sm:px-8 sm:pt-20">
        <div className="mx-auto w-full max-w-6xl">
          {isRefreshing ? (
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] py-4 lg:min-h-[560px] lg:py-14">
              <div className="pointer-events-none absolute -right-28 top-1/2 hidden w-[68%] -translate-y-1/2 opacity-75 lg:block">
                <div className="absolute -inset-12 bg-[radial-gradient(circle_at_55%_50%,rgba(192,234,112,0.24),transparent_62%)] blur-2xl" />
                <div className="relative [mask-image:linear-gradient(to_right,transparent_0%,black_22%,black_100%)]">
                  <BeforeAfterReveal
              ...
              <div className="relative z-10 max-w-xl rounded-[2rem] bg-[#faf8f1]/75 py-6 backdrop-blur-[1px] lg:bg-[#faf8f1]/80 lg:px-0">
              ...
              <div className="relative z-10 mx-auto mt-10 w-full max-w-2xl lg:hidden">
                <BeforeAfterReveal
                  before={engineerBeforePreview}
                  after={engineerAfterPreview}
                  beforeAlt="Original engineering website before Refresh Kiwi"
                  afterAlt="Refreshed engineering website generated by Refresh Kiwi"
                  priority
                  aspectClassName="h-[250px] sm:h-[320px] lg:h-[380px]"
