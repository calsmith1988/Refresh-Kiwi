          ...
          {isRefreshing ? (
            ...
            <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="relative mx-auto min-h-[390px] w-full max-w-xl sm:min-h-[470px] lg:max-w-none">
                ...
                <div className="absolute bottom-0 right-0 w-[68%] rotate-2 rounded-[1.8rem] border-2 border-kiwi-green bg-white p-2.5 shadow-2xl shadow-[#8bbf4d]/25">
                  <div className="flex items-center justify-between px-2 pb-2 pt-1">
                    <span className="rounded-full bg-kiwi-green px-3 py-1 text-[10px] font-black uppercase tracking-[0.16em] text-black">
                      After Refresh Kiwi
                    </span>
                  </div>
                  <div className="relative h-[240px] overflow-hidden rounded-2xl bg-black sm:h-[300px]">
                    <Image
