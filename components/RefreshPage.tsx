        ...
        <div className="mx-auto w-full max-w-6xl">
          {isRefreshing ? (
            ...
            <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="relative mx-auto min-h-[380px] w-full max-w-xl sm:min-h-[460px] lg:max-w-none">
                <div className="absolute left-0 top-3 w-[76%] -rotate-2 rounded-[1.6rem] border border-black/10 bg-white p-2.5 opacity-80 shadow-xl shadow-black/10">
                  <div className="flex items-center justify-between px-2 pb-2 pt-1">
                    <span className="rounded-full bg-black/70 px-3 py-1 text-[10px] font-black uppercase tracking-[0.16em] text-white">
                      Before
                    </span>
                  </div>
                  <div className="relative h-[260px] overflow-hidden rounded-2xl bg-black sm:h-[330px]">
                    <Image
                ...
                <div className="absolute bottom-0 right-0 w-[82%] rotate-2 rounded-[1.8rem] border-2 border-kiwi-green bg-white p-2.5 shadow-2xl shadow-[#8bbf4d]/25">
                  <div className="flex items-center justify-between px-2 pb-2 pt-1">
